      ...
      <div>
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Business</h3>
                    <p>As coming from the Business background, I have good grasp over fundamental concepts of sales, consumer wants, needs, and expectations! As well as, price point equilibriums and quantity produced vs quantity demanded.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Dev Ops</h3>
                    <p>I am pursuing my education with Rutger's University's full-stack bootcamp, FrontEndMasters courses, and FreeCodeCamp!</p>
                </div>
                </div>
            </div>
            </div>
